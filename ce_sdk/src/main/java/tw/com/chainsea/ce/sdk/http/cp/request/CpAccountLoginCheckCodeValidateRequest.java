...
public class CpAccountLoginCheckCodeValidateRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpAccountLoginCheckCodeValidateRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.ACCOUNT_LOGIN_CHECK_CODE_VALIDATE);
