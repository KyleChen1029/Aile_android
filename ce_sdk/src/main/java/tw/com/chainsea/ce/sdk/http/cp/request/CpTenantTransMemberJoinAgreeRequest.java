...
public class CpTenantTransMemberJoinAgreeRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpTenantTransMemberJoinAgreeRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TENANT_TRANS_MEMBER_JOIN_AGREE);
