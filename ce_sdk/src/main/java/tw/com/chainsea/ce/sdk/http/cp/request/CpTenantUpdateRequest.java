...
public class CpTenantUpdateRequest extends NewRequestBase {
    private final CpApiListener<String> listener;

    public CpTenantUpdateRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TENANT_UPDATE);
