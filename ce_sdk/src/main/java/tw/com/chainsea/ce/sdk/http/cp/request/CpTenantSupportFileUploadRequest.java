...
public class CpTenantSupportFileUploadRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpTenantSupportFileUploadRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TENANT_SUPPORT_FILE_UPLOAD);
