...
public class CpCheckVersionRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpCheckVersionRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.BASE_VERSION_CHECK);
