...
public class CpTenantGuarantorAgreeRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpTenantGuarantorAgreeRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TENANT_GUARANTOR_AGREE);
