...
public class CpAccountLoginDeviceScanRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpAccountLoginDeviceScanRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.ACCOUNT_LOGIN_DEVICE_SCAN);
