...
public class CpTenantTransActiveRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpTenantTransActiveRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TENANT_TRANS_ACTIVE);
