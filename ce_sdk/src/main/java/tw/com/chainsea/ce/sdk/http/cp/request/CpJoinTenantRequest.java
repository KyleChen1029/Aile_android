...
public class CpJoinTenantRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpJoinTenantRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TENANT_JOIN);
