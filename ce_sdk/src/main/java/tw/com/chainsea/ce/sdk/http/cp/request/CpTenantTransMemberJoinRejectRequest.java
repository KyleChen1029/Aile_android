...
public class CpTenantTransMemberJoinRejectRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpTenantTransMemberJoinRejectRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TENANT_TRANS_MEMBER_JOIN_REJECT);
