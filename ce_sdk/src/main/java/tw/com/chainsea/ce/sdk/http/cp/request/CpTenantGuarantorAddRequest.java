...
public class CpTenantGuarantorAddRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpTenantGuarantorAddRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TENANT_GUARANTOR_ADD);
