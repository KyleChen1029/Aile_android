...
public class CpTenantDictionaryScaleRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpTenantDictionaryScaleRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TENANT_DICTIONARY_SCALE);
