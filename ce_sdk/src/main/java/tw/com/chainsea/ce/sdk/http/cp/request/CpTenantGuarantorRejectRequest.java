...
public class CpTenantGuarantorRejectRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpTenantGuarantorRejectRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TENANT_GUARANTOR_REJECT);
