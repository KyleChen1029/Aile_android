...
public class CpAccountDeviceRecordRememberAddRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpAccountDeviceRecordRememberAddRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.ACCOUNT_DEVICE_RECORD_REMEMBER_ADD);
