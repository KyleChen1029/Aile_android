...
public class CpTokenRefreshRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpTokenRefreshRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TOKEN_REFRESH);
