...
public class CpTenantTransDismissRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpTenantTransDismissRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TENANT_TRANS_DISMISS);
