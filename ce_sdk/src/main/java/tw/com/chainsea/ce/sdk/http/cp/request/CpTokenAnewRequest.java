...
public class CpTokenAnewRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpTokenAnewRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TOKEN_ANEW);
