...
public class CpTenantGuarantorCancelRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpTenantGuarantorCancelRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TENANT_GUARANTOR_CANCEL);
