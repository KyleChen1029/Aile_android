...
public class CpTenantDictionaryIndustryRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpTenantDictionaryIndustryRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TENANT_DICTIONARY_INDUSTRY);
