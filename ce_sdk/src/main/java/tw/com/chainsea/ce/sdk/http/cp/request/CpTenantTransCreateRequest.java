...
public class CpTenantTransCreateRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpTenantTransCreateRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TENANT_TRANS_CREATE);
