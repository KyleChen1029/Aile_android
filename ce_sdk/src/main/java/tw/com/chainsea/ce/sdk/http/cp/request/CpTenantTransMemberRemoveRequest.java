...
public class CpTenantTransMemberRemoveRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpTenantTransMemberRemoveRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TENANT_TRANS_MEMBER_REMOVE);
