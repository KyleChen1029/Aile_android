...
public class CpTenantItemRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpTenantItemRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TENANT_ITEM);
