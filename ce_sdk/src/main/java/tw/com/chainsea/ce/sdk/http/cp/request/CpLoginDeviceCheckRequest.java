...
public class CpLoginDeviceCheckRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpLoginDeviceCheckRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.LOGIN_DEVICE_CHECK);
