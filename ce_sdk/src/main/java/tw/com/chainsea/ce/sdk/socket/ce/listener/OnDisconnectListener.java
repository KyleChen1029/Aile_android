 ...
 * @date 2020-10-22
 */
public abstract class OnDisconnectListener implements Emitter.Listener {

    protected abstract void disconnect(String data);
    ...
    public void call(Object... args) {
        ThreadExecutorHelper.getSocketExecutor().execute(() -> {
            ...
            while (iterator.hasNext()) {
                ...
                disconnect("");
                CELog.i("disconnect::: ", JsonHelper.getInstance().toJson(obj));
            }
        });
