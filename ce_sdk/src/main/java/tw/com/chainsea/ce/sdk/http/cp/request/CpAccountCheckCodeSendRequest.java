...
public class CpAccountCheckCodeSendRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpAccountCheckCodeSendRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.ACCOUNT_CHECK_CODE_SEND);
