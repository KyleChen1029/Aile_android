...
public class CpGetInvitationCodeRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpGetInvitationCodeRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.JOIN_TENANT_INVITE_CODE);
