...
public class CpTenantRelationListRequest extends CpNewRequestBase {
    private final CpApiListener<String> listener;

    public CpTenantRelationListRequest(Context ctx, CpApiListener<String> listener) {
        super(ctx, CpApiPath.TENANT_RELATION_LIST);
