...
public class CharacterParserUtil {
    private static final int[] pyvalue = new int[]{-20319, -20317, -20304, -20295, -20292, -20283,
    ...
    private static final CharacterParserUtil characterParser = new CharacterParserUtil();
