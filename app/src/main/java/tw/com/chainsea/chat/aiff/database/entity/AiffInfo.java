...
@Entity(tableName = "aiffInfo")
public class AiffInfo {
    ...
    public AiffInfo(@NonNull String id, String tenantId, Integer index, String displayLocation,
