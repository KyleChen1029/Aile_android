...
public interface IPhotoView {
     ...
     *
     * @param listener - OnNoticeListener to be registered.
     */
     ...
     * <p>&nbsp;</p>
     * Returns a onAvatarListener to be invoked when the Photo displayed by this View is tapped with a
     * single tap.
     *
     ...
     * will be removed in future release.
     * <p>&nbsp;</p>
     * Returns a callback onAvatarListener to be invoked when the View is tapped with a single tap.
     *
    ...
    /**
     * Sets custom double tap onAvatarListener, to intercept default given functions. To reset behavior to
