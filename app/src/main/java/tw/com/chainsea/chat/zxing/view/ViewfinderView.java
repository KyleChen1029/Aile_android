...
package tw.com.chainsea.chat.zxing.view;
...
public final class ViewfinderView extends View {
    ...
    public void onDraw(@NonNull Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            // Req another update at the animation interval, but only repaint the laser line,
    ...
    private void drawTextInfo(Canvas canvas, Rect frame) {
        ...
        canvas.drawText(labelText, frame.left + frame.width() / 2f, frame.top - CORNER_RECT_HEIGHT, paint);
    }
