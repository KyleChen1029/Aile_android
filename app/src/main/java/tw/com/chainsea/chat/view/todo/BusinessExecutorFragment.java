...
import tw.com.chainsea.chat.databinding.FragmentBusinessExecutorBinding;
...
public class BusinessExecutorFragment extends BaseFragment<TodoOverviewType, BusinessEntity> implements IBusinessFragment, BusinessListMeAdapter.OnBusinessListMeItemClockListener<BusinessEntity> {
    ...
    TodoOverviewType type = TodoOverviewType.BUSINESS_EXECUTOR;

    private FragmentBusinessExecutorBinding binding;

    public BusinessExecutorFragment() {
    }

    public static BusinessExecutorFragment newInstance() {
        return new BusinessExecutorFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentBusinessExecutorBinding.inflate(inflater, container, false);
