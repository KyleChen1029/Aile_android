 ...
 */
public class TextMessageView extends MessageBubbleView<TextContent> {

    private final MsgkitTextBinding binding;
    public TextMessageView(@NonNull ViewBinding binding) {
        super(binding);
        this.binding = MsgkitTextBinding.inflate(LayoutInflater.from(itemView.getContext()), null, false);
    ...
    protected void bindContentView(TextContent textContent) {
        ...
        Spannable text = new UrlTextUtil().getUrlSpannableString(binding.contentCTV, KeyWordHelper.matcherSearchBackground(0xFFFFF039, content, getKeyword()));
        binding.contentCTV.setText(text, TextView.BufferType.NORMAL);
