 ...
 */
public class ChildImageMessageView extends ChildMessageBubbleView<ImageContent> {

    private MsgkitImageBinding binding;

    final static int SMALL_PIC_SIZE = 400;

    public ChildImageMessageView(@NonNull ViewBinding binding) {
        super(binding);
    }

    @Override
    protected void bindView(View itemView) {
        binding = MsgkitImageBinding.inflate(LayoutInflater.from(itemView.getContext()), null, false);
    }
