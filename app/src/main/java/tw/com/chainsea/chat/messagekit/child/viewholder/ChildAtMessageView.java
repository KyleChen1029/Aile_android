 ...
 */
public class ChildAtMessageView extends ChildMessageBubbleView<AtContent> {
    private static final String TAG = ChildAtMessageView.class.getSimpleName();

    private MsgkitAtBinding binding;


    public ChildAtMessageView(@NonNull ViewBinding binding) {
        super(binding);
    }
    ...
    protected void bindView(View itemView) {
        binding = MsgkitAtBinding.inflate(LayoutInflater.from(itemView.getContext()), null, false);
    }
    ...
    protected void bindContentView(AtContent atContent) {
        ...
        if (message.content() instanceof AtContent) {
            ...
            binding.contentCTV.setMovementMethod(new AtClickLinkMovementMethod<MessageEntity>(getContext(), true, getMessage()) {
                @Override
