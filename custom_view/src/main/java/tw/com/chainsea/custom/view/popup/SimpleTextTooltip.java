...
public class SimpleTextTooltip implements PopupWindow.OnDismissListener {

    private static final String TAG = SimpleTextTooltip.class.getSimpleName();
    ...
    private final long mDismissTimer;
    ...
    private SimpleTextTooltip(Builder builder) {
        ...
        mDismissTimer = builder.dismissTimer;
    ...
    public void show() {
        ...
        mRootView.post(() -> {
            if (mRootView.isShown())
                if (mText.equals("按此轉回 AI 服務")) {
                    PopupWindowCompat.showAsDropDown(mPopupWindow, mAnchorView, -(int) (mRootView.getWidth() * 0.28), -((int) (mAnchorView.getWidth() * 2.4)), Gravity.END);
                } else {
        ...
        if (mDismissTimer > 0L) {
            new Handler().postDelayed(() -> {
                if (mRootView != null && mRootView.isShown() && mPopupWindow != null)
    ...
    private final ViewTreeObserver.OnGlobalLayoutListener mShowLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
        ...
        public void onGlobalLayout() {
            ...
            if (mOnShowListener != null)
                mOnShowListener.onShow(SimpleTextTooltip.this);
    ...
    /**
     * <div class="pt">Listener utilizado para chamar o <tt>SimpleTextTooltip#dismiss()</tt> quando a <tt>View</tt> root é encerrada sem que a tooltip seja fechada.
    ...
    public interface OnDismissListener {
        void onDismiss(SimpleTextTooltip tooltip);
    }

    public interface OnShowListener {
        void onShow(SimpleTextTooltip tooltip);
    }

    /**
     * <div class="pt">Classe responsável por facilitar a criação do objeto <tt>SimpleTextTooltip</tt>.</div>
     * <div class="en">Class responsible for making it easier to build the object <tt>SimpleTextTooltip</tt>.</div>
     *
    ...
    public static class Builder {
        ...
        public SimpleTextTooltip build() throws IllegalArgumentException {
            validateArguments();
            ...
            return new SimpleTextTooltip(this);
        }
        ...
        /**
         * <div class="pt">Define o tamanho do deslocamento durante a animação. Padrão é o valor de <tt></tt>.</div>
         *
        ...
        /**
         * <div class="pt">Define o tamanho do deslocamento durante a animação. Padrão é <tt></tt>.</div>
         *
        ...
        /**
         * <div class="pt">Define o padding entre a borda do Tooltip e seu conteúdo. Padrão é o valor <tt></tt>.</div>
         *
        ...
        /**
         * <div class="pt">Define o padding entre a borda do Tooltip e seu conteúdo. Padrão é <tt></tt>.</div>
         *
        ...
        /**
         * <div class="pt">Define a margem entre o Tooltip e o <tt>anchorView</tt>. Padrão é o valor de <tt></tt>.</div>
         *
        ...
        /**
         * <div class="pt">Define a margem entre o Tooltip e o <tt>anchorView</tt>. Padrão é <tt></tt>.</div>
         *
        ...
        public Builder arrowHeight(float arrowHeight) {
            this.arrowHeight = UiHelper.dp2px(context, arrowHeight);
//            this.arrowHeight = arrowHeight;
        ...
        public Builder arrowWidth(float arrowWidth) {
            this.arrowWidth = UiHelper.dp2px(context, arrowWidth);
//            this.arrowWidth = arrowWidth;
         ...
         * @return
         */
        public Builder dismissTimer(long dismissTimer) {
