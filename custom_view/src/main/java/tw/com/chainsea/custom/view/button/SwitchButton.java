package tw.com.chainsea.custom.view.button;
...
public class SwitchButton extends View implements Checkable {
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        canvas.drawRoundRect(left + des, top + des, right - des, bottom - des,
            viewRadius, viewRadius, paint);
    ...
    protected void drawCheckedIndicator(Canvas canvas) {
        paint.setStyle(Paint.Style.STROKE);
        paint.setColor(viewState.checkedLineColor);
        paint.setStrokeWidth(checkLineWidth);
        canvas.drawLine(
            left + viewRadius - checkedLineOffsetX,
            centerY - checkLineLength,
    ...
    private void drawUncheckIndicator(Canvas canvas) {
        paint.setStyle(Paint.Style.STROKE);
        paint.setColor(uncheckCircleColor);
        paint.setStrokeWidth(uncheckCircleWidth);
        canvas.drawCircle(right - uncheckCircleOffsetX,
            centerY,
            uncheckCircleRadius,
            paint);
    }
