package tw.com.chainsea.android.common.reflection;
...
public class ReflectionUtil {
    ...
    /**
     * value is the fully qualified class name prefixed
     * with . This method will substring it, for it to be eligible
